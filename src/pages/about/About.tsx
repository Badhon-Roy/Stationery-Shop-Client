            ...
            <div className="w-full h-full p-8">
                <div className="items-center justify-between gap-8 md:flex">
                    ...
                    <div className="flex-1 mt-8 md:mt-0" >
                        ...
                        <div data-aos="fade-right" className="relative px-4 py-5 bg-white shadow-md rounded-2xl md:w-full lg:w-3/4">
                        ...
                        <div data-aos="fade-right" className="relative px-4 py-5 my-4 bg-white shadow-md rounded-2xl md:w-full lg:w-3/4">
